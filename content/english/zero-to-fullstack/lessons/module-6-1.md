...
装的时候你可能会发现一个现象：pypinyin 一下就好，**snownlp 明显大很多**。为什么？因为这个包其实是个中文处理的**百宝箱**——它不光做情感分析，还打包了像分词这样好几样功能，每一样各自都带着不小的模型和语料数据，体积自然就上去了。而真正给句子打分的，是包里那个**别人已经训练好的模型**——模型不是代码，而是别人做的训练结果，我们 import 一下就能直接用。如果对于“模型”、“训练”这些词感觉很陌生的朋友，你先不要担心，我们今天毕竟是用轮子，如果你不知道轮胎的橡胶是怎么加工的，其实也没关系。
